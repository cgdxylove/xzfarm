...
import com.xzff.modulestore.beans.WebResponse;
import com.xzff.modulestore.beans.constant.CommonConstant;
import com.xzff.modulestore.beans.constant.SeckillConstant;
import com.xzff.modulestore.dao.ProImagesMapper;
import com.xzff.modulestore.dao.ProSeckillMapper;
    ...
    public ProSeckillDetailVO getSeckillDetail(int seckillId, int productType) {
        ...
        switch (productType) {
            case CommonConstant.PRODUCT_TYPE_PRODUCT://普通产品
                seckillDetailVO = proSeckillMapper.getProductSeckillDetailVO(seckillId,date);
                break;
            case CommonConstant.PRODUCT_TYPE_PACKAGE://产品包
                seckillDetailVO = proSeckillMapper.getPackageSeckillDetailVO(seckillId,date);
                break;
            default:
                break;
        }
        ...
        List<String> imgUrls = proImagesMapper.queryDetailsImageUrlsByObjectId(productId);
